 ...
 */
package com.example.arcoredemo.common.rendering;
...
import com.example.arcoredemo.common.CloudInterface;
import com.example.arcoredemo.common.LidarPoint;
import com.example.arcoredemo.common.LidarPointCloud;
import com.google.ar.core.PointCloud;

import java.io.IOException;

/** Renders a point cloud. */
public class MyPointCloudRenderer {
   ...
   */
  public void update(CloudInterface cloud) {
  ...
  public void draw(float[] cameraView, float[] cameraPerspective) {
    ...
    GLES20.glUniform4f(colorUniform, 255.0f / 255.0f, 1.0f / 255.0f, 1.0f / 255.0f, 1.0f);
